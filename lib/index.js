						...
						switch (_context.prev = _context.next) {
							...
							case 10:
								...
								if (response instanceof Array || typeof response === 'string') {
									...
									if (multiple === false) {
										_imagePreviewUrls2 = response instanceof Array ? 'https://res.cloudinary.com/ashmemories/image/upload/c_fill,h_100,w_100/' + response : ['https://res.cloudinary.com/ashmemories/image/upload/c_fill,h_100,w_100/' + response];
									} else {
										_imagePreviewUrls2 = this.state.imagePreviewUrls.concat('https://res.cloudinary.com/ashmemories/image/upload/c_fill,h_100,w_100/' + response);
									}
									this.setState({
